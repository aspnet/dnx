...
namespace kre.hosting
{
    internal static class RuntimeBootstrapper
    {
        ...
        public static Task<int> ExecuteAsync(string[] args)
        {
            ...
            try
            {
                var assembly = Assembly.Load(new AssemblyName("kre.host"));
                ...
                var loaderContainerType = assembly.GetType("kre.host.LoaderContainer");
                var cachedAssemblyLoaderType = assembly.GetType("kre.host.CachedAssemblyLoader");
                var pathBasedLoaderType = assembly.GetType("kre.host.PathBasedAssemblyLoader");
                ...
                var bootstrapperType = assembly.GetType("kre.host.Bootstrapper");
