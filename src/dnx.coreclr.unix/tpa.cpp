...
BOOL CreateTpaBase(LPCTSTR** ppNames, size_t* pcNames, bool bNative)
{
    ...
    if (bNative)
    {
        ...
        pArray[4] = _T("Microsoft.Framework.Runtime.Interfaces.ni.dll");
        pArray[5] = _T("Microsoft.Framework.Runtime.Loader.ni.dll");
        pArray[6] = _T("mscorlib.ni.dll");
        ...
        pArray[12] = _T("System.Diagnostics.Debug.ni.dll");
        pArray[13] = _T("System.Diagnostics.Tracing.ni.dll");
        ...
        pArray[19] = _T("System.Private.Uri.ni.dll");
    ...
    else
    {
        ...
        pArray[4] = _T("Microsoft.Framework.Runtime.Interfaces.dll");
        pArray[5] = _T("Microsoft.Framework.Runtime.Loader.dll");
        pArray[6] = _T("mscorlib.dll");
        ...
        pArray[12] = _T("System.Diagnostics.Debug.dll");
        pArray[13] = _T("System.Diagnostics.Tracing.dll");
        ...
        pArray[19] = _T("System.Private.Uri.dll");
