// kre.coreclr.cpp : Defines the exported functions for the DLL application.
//

#include "stdafx.h"

#include "..\klr\klr.h"
#include "kre.coreclr.h"
#include "tpa.h"
...
bool Win32KDisable()
{
    ...
    DWORD dwRet = GetEnvironmentVariableW(L"KRE_WIN32K_DISABLE", szWin32KDisable, _countof(szWin32KDisable));
    fSuccess = dwRet > 0;
    if (!fSuccess)
    {
        goto Finished;
