...
BOOL CreateTpaBase(LPWSTR** ppNames, size_t* pcNames, bool bNative)
{
    ...
    if (bNative)
    {
        ...
        pArray[3] = _wcsdup(L"System.ni.dll");
        pArray[4] = _wcsdup(L"System.AppContext.ni.dll");
        pArray[5] = _wcsdup(L"System.Collections.ni.dll");
        pArray[6] = _wcsdup(L"System.Collections.Concurrent.ni.dll");
        pArray[7] = _wcsdup(L"System.ComponentModel.ni.dll");
        pArray[8] = _wcsdup(L"System.Console.ni.dll");
        pArray[9] = _wcsdup(L"System.Core.ni.dll");
        pArray[10] = _wcsdup(L"System.Diagnostics.Debug.ni.dll");
        ...
        pArray[27] = _wcsdup(L"System.Threading.ni.dll");
        pArray[28] = _wcsdup(L"System.Threading.Overlapped.ni.dll");
        pArray[29] = _wcsdup(L"System.Threading.Tasks.ni.dll");
        pArray[30] = _wcsdup(L"System.Threading.ThreadPool.ni.dll");
    }
    else
    {
        ...
        pArray[3] = _wcsdup(L"System.dll");
        pArray[4] = _wcsdup(L"System.AppContext.dll");
        pArray[5] = _wcsdup(L"System.Collections.dll");
        pArray[6] = _wcsdup(L"System.Collections.Concurrent.dll");
        pArray[7] = _wcsdup(L"System.ComponentModel.dll");
        pArray[8] = _wcsdup(L"System.Console.dll");
        pArray[9] = _wcsdup(L"System.Core.dll");
        pArray[10] = _wcsdup(L"System.Diagnostics.Debug.dll");
        ...
        pArray[27] = _wcsdup(L"System.Threading.dll");
        pArray[28] = _wcsdup(L"System.Threading.Overlapped.dll");
        pArray[29] = _wcsdup(L"System.Threading.Tasks.dll");
        pArray[30] = _wcsdup(L"System.Threading.ThreadPool.dll");
    }
