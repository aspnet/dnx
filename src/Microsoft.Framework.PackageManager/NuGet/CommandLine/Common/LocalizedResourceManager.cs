...
namespace NuGet
{
    ...
    {
        private static readonly ResourceManager _resourceManager = new ResourceManager("Microsoft.Framework.PackageManager.NuGet.NuGetResources", typeof(LocalizedResourceManager).GetTypeInfo().Assembly);
