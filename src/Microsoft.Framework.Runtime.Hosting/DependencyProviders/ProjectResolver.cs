...
namespace Microsoft.Framework.Runtime.Hosting.DependencyProviders
{
    public class ProjectResolver : IProjectResolver
    {
        ...
        public static ProjectResolver ForProjectDirectory(string applicationBaseDirectory)
        {
            return new ProjectResolver(
                applicationBaseDirectory,
                ResolveRootDirectory(applicationBaseDirectory));
        }
        ...
        private class ProjectInformation
        {
            ...
            public Project Project
            {
                get
                {
                    ...
                    {
                        return ProjectReader.HasProjectFile(FullPath) ?
                            ProjectReader.ReadProjectFile(FullPath) :
                            null;
                    });
                }
            }
