...
const std::vector<const dnx::char_t*> CreateTpaBase(bool native_images)
{
    return native_images
        ? std::vector<const dnx::char_t*>
        {
            ...
            _X("Microsoft.Extensions.PlatformAbstractions.Dnx.ni.dll"),
            _X("System.AppContext.ni.dll"),
            _X("System.Buffers.ni.dll"),
            ...
            _X("System.Runtime.InteropServices.PInvoke.ni.dll"),
        ...
        : std::vector<const dnx::char_t*>
        {
            ...
            _X("Microsoft.Extensions.PlatformAbstractions.Dnx.dll"),
            _X("System.AppContext.dll"),
            _X("System.Buffers.dll"),
            ...
            _X("System.Runtime.InteropServices.PInvoke.dll"),
