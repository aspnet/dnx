...
namespace Microsoft.Framework.Runtime.Roslyn
{
    public class BeforeCompileContext
    {
        ...
        {
            get { return Init(ref _resources, ref _lazyResources); }
            set { _resources = value; }
        }

        public IList<Diagnostic> Diagnostics
        {
            get { return Init(ref _diagnostics, ref _lazyDiagnostics); }
            set { _diagnostics = value; }
        }

        public IList<IMetadataReference> MetadataReferences
        {
            get { return Init(ref _metadataReferences, ref _lazyMetadataReferences); }
            set { _metadataReferences = value; }
        }
